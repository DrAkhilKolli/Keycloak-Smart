...
public interface ServicesLogger extends BasicLogger {
    ...
    ServicesLogger LOGGER = createLogger();

    private static ServicesLogger createLogger() {
        try {
            return Logger.getMessageLogger(
                    MethodHandles.privateLookupIn(ServicesLogger.class, MethodHandles.lookup()),
                    ServicesLogger.class,
