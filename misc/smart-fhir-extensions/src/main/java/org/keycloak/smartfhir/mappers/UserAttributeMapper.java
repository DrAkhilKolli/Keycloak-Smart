...
public class UserAttributeMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper,
    ...
    static {
        ...
        OIDCAttributeMapperHelper.addAttributeConfig(CONFIG_PROPERTIES, UserAttributeMapper.class);
